...
\begin{figure}[ht]
\centering
\includegraphics[width=\columnwidth]{figures/figure6_physics_guided_3d_framework.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\columnwidth]{figures/figure5_enhanced_3d_architecture.pdf}
...
\caption{Experimental protocols overview: D2 robustness (540 configurations), \gls{cdae} (\gls{loso}/\gls{loro}), and \gls{stea} label-efficiency evaluation.}
\label{fig:protocols}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\columnwidth]{figures/figure3_advanced_violin.pdf}
\caption{Cross-domain generalization performance using distribution-based violin plots comparing \gls{loso} and \gls{loro} across models. The Enhanced model achieves identical 83.0±0.1\% macro F1 in both protocols with exceptional stability ($\text{CV}<0.2\%$).}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\columnwidth]{figures/figure4_advanced_bubble.pdf}
\caption{Sim2Real label efficiency of the Enhanced model. Only 20\% labeled real data achieves 82.1\% macro F1 (80\% labeling cost reduction). The efficiency curve exhibits three phases: Bootstrap (1\%), Rapid growth (5--10\%), and Convergence (\(\geq\)20\%).}
