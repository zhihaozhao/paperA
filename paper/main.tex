...
% PCA analysis figure (original Figure 6) added for completeness in Methods
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/figure7_pca_analysis.pdf}
\caption{PCA analysis of feature space illustrating variance explained and class separability used to guide architectural choices.}
