...
\caption{PSTA/ESTA macro F1 comparison across models (mean ± std over seeds). PSTA (left) stresses harder settings; ESTA (right) confirms stability with additional GPU runs.}
