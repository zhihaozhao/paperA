...
\begin{figure}[ht]
\centering
\includegraphics[width=\columnwidth]{paper/enhanced/plots/ablation_noise_env.pdf}
\caption{Environmental Noise Ablation Analysis: Performance heatmap showing macro F1 across varying class overlap (y-axis) and environmental burst noise (x-axis) conditions. The Enhanced model demonstrates superior robustness to nuisance factors, maintaining high performance even under challenging noise conditions that significantly degrade baseline architectures.}
