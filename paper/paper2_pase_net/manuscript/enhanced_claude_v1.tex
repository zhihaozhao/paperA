...
\caption{Cross-Domain Performance Analysis of all four models. PASE-Net demonstrates exceptional domain consistency with identical LOSO (83.0\%) and LORO (83.0\%) performance, while CNN shows 4.5\% gap, BiLSTM 1.4\% gap, and Conformer exhibits convergence issues in LOSO (40.3\%) but recovers in LORO (84.1\%). The visualization includes performance comparison, domain gap analysis, and statistical summary. Extended analysis is provided in Supplementary Figure S1.}
